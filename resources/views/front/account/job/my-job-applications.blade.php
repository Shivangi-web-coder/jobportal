                                        ...
                                        <td>
                                            <div class="action-dots float-end">
                                                ...
                                                <ul class="dropdown-menu dropdown-menu-end">
                                                    ...
                                                    <li><a class="dropdown-item" href="javascript:void(0)" onClick="deleteJob({{ $jobApplication->id }})"><i class="fa fa-trash" aria-hidden="true"></i> Remove</a></li>
                                                </ul>
                                            </div>
                                        </td>
                                    </tr>
...
<script type="text/javascript">
    function deleteJob(id){
        if(confirm("Are you sure you want to remove?")){
            $.ajax({
                url:'{{ route("account.removeJobApplications") }}',
                type:'post',
                data:{id:id},
                dataType:'json',
